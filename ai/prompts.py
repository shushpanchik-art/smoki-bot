...
SAGA_RULES = (
    ...
    "12. КАВЫЧКИ: для прямой речи и цитат используй ТОЛЬКО русские "
    "ёлочки «...». Не используй \"...\" и '...'. Кавычки всегда "
    "парные: каждая открывающая « имеет закрывающую ». Прямую речь "
    "оформляй либо через тире (— реплика), либо в ёлочках — но не "
    "курсивом.\n"
    "13. КУРСИВ <i> ТОЛЬКО для смыслового акцента на слове или "
    "внутренней мысли героя. НИКОГДА не выделяй курсивом названия "
    "брендов, марок, компаний, гаджетов и заведений (iPhone, Porsche "
    "Panamera, «Альфа», VapeCorp пишутся обычным текстом; названия "
    "компаний — в ёлочках без курсива).\n"
