...
## Структура
`bot.py, config.py, scheduler.py, db/(schema.sql, database.py),
ai/(gemini.py, prompts.py), services/(content.py, publisher.py, comments.py),
handlers/(admin.py, group.py, __init__→ROUTERS), scripts/ai_healthcheck.py`
