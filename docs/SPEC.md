...
- [ ] U8.1 Экран «🗓 Расписания» в inline-панели (`adm_schedule`): читает
...
- [ ] U8.2 Редактирование параметров расписания через кнопки (аналогично
...
- [ ] U8.3 Кнопка «Пауза/Возобновить» отдельной джобы
      (`scheduler.pause_job/resume_job` по id) — например временно
      остановить сторис, не трогая посты.
- [ ] U8.4 Тесты (tmp_db + мок scheduler): формирование текста экрана,
